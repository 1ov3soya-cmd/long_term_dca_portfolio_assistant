...
## 7. 关键 summary 指标差异
- baseline_assessment: value_a=, value_b=中性可用, direction=added, absolute_change=, relative_change=
- effective_in_range_count: value_a=9.0, value_b=, direction=removed, absolute_change=, relative_change=
- etf_risk_rule_recommendation: value_a=, value_b=保留, direction=added, absolute_change=, relative_change=
- force_review_count: value_a=0.0, value_b=, direction=removed, absolute_change=, relative_change=
- keep_first_trading_day_default: value_a=, value_b=保留, direction=added, absolute_change=, relative_change=
- keep_forward_default: value_a=, value_b=保留，但需备注限制, direction=added, absolute_change=, relative_change=
- pause_buy_count: value_a=0.0, value_b=, direction=removed, absolute_change=, relative_change=
- stock_risk_rule_recommendation: value_a=, value_b=证据不足，暂不调整, direction=added, absolute_change=, relative_change=
- symbols_flagged: value_a=9.0, value_b=, direction=removed, absolute_change=, relative_change=
- thesis_broken_count: value_a=0.0, value_b=, direction=removed, absolute_change=, relative_change=
...
- 最大结果差异: baseline_assessment，value_a=，value_b=中性可用
